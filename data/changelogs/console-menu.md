...
Update `console-menu` stubs for v0.8 ([#9845](https://github.com/python/typeshed/pull/9845))
...
Remove `consolemenu` from `pyright`'s exclude ([#8940](https://github.com/python/typeshed/pull/8940))

## 0.7.0.0 (2022-10-03)

Add type stubs for package console-menu ([#8820](https://github.com/python/typeshed/pull/8820))
