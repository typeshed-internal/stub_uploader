...
Fix typos in `extra_description` fields ([#9883](https://github.com/python/typeshed/pull/9883))
...
`gdb-stubs` fixes ([#9439](https://github.com/python/typeshed/pull/9439))
...
Add type stubs for gdb.Value comparison operators ([#9411](https://github.com/python/typeshed/pull/9411))

## 12.1.4 (2022-09-24)

gdb: add missing automatic imports ([#8788](https://github.com/python/typeshed/pull/8788))
...
Various fixes in `gdb` ([#8144](https://github.com/python/typeshed/pull/8144))
...
Add stubs for "gdb" ([#8013](https://github.com/python/typeshed/pull/8013))
