...
Mark `decorator` as complete ([#8897](https://github.com/python/typeshed/pull/8897))
...
Add `ParamSpec` to `decorator.contextmanager` ([#7051](https://github.com/python/typeshed/pull/7051))
