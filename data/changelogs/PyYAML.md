...
[PyYAML] type the whole Emitter class ([#10750](https://github.com/python/typeshed/pull/10750))
...
[PyYAML] Improve dump/serialize types ([#10196](https://github.com/python/typeshed/pull/10196))
...
Type `Loader` parameter in `PyYAML/yaml` ([#9752](https://github.com/python/typeshed/pull/9752))

## 6.0.12.6 (2023-02-13)

[PyYAML] Accept all iterables for dump_all functions ([#9725](https://github.com/python/typeshed/pull/9725))

## 6.0.12.5 (2023-02-09)

yaml: allow ReadableBuffer in represent_binary ([#9701](https://github.com/python/typeshed/pull/9701))
...
PyYAML: Permit `width: float` for pure-Python `dump(...)` ([#8973](https://github.com/python/typeshed/pull/8973))
...
Add a couple of missing type hints in pyyaml.constructor ([#8965](https://github.com/python/typeshed/pull/8965))
...
`PyYaml`’s Serializer: annotate `open`, `close`, `serialize` ([#8383](https://github.com/python/typeshed/pull/8383))
...
PyYAML: check missing defs ([#8159](https://github.com/python/typeshed/pull/8159))

## 6.0.8 (2022-06-01)

PyYAML: Add types to `add_constructor` ([#7989](https://github.com/python/typeshed/pull/7989))
...
Replace IO with protocols ([#7092](https://github.com/python/typeshed/pull/7092))
...
Add more type hints for pyyaml ([#6265](https://github.com/python/typeshed/pull/6265))

## 6.0.0 (2021-10-22)

Upgrade PyYAML to version 6 ([#6183](https://github.com/python/typeshed/pull/6183))
...
Delete yaml.CDangerLoader and yaml.CDangerDumper ([#5990](https://github.com/python/typeshed/pull/5990))

These no longer exist in PyYAML 4.2.

## 5.4.9 (2021-09-01)

Add C{Full,Unsafe}Loader and UnsafeConstructor ([#5988](https://github.com/python/typeshed/pull/5988))
