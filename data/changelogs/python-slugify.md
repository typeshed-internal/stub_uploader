...
[stubsabot] Bump python-slugify to 8.0.* ([#9602](https://github.com/python/typeshed/pull/9602))
...
python-slugify: use explicit re-exports ([#9225](https://github.com/python/typeshed/pull/9225))

Fixes https://github.com/python/typeshed/pull/9224#discussion_r1027053364

## 7.0.0.0 (2022-11-19)

[stubsabot] Bump python-slugify to 7.0.* ([#9224](https://github.com/python/typeshed/pull/9224))
...
Mark `python-slugify` as completed ([#9222](https://github.com/python/typeshed/pull/9222))

## 6.1.0 (2022-06-29)

[stubsabot] Bump python-slugify to 6.1.* ([#8208](https://github.com/python/typeshed/pull/8208))
...
Fix python-slugify replacements argument type ([#6004](https://github.com/python/typeshed/pull/6004))
