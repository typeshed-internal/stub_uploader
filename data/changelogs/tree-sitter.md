...
Pin `tree-sitter` to 0.20.1 ([#10677](https://github.com/python/typeshed/pull/10677))
...
Remove `tree-sitter` from `pyright`'s exclude ([#8946](https://github.com/python/typeshed/pull/8946))

Co-authored-by: Akuli <akuviljanen17@gmail.com>

## 0.20.1 (2022-09-06)

tree-sitter: add missing members ([#8693](https://github.com/python/typeshed/pull/8693))

## 0.20.0 (2022-08-17)

Add stubs for tree_sitter ([#8533](https://github.com/python/typeshed/pull/8533))
