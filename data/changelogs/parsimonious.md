## [0.11.0.20260724](https://pypi.org/project/types-parsimonious/0.11.0.20260724/) (2026-07-24)
...
`parsimonious`: Update return types of `NodeVisitor`'s methods ([#9564](https://github.com/python/typeshed/pull/9564))
...
Mark `parsimonious` as completed ([#8934](https://github.com/python/typeshed/pull/8934))

## 0.10.0 (2022-09-13)

Update parsimonious to 0.10.0 ([#8730](https://github.com/python/typeshed/pull/8730))
...
Bump parsimonious to 0.9.* ([#8117](https://github.com/python/typeshed/pull/8117))
...
parsimonious: `re.Match` does not exist in Python 3.6 ([#7482](https://github.com/python/typeshed/pull/7482))
...
Stubs for parsimonious ([#7477](https://github.com/python/typeshed/pull/7477))
