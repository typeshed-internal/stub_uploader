...
Mark `python-nmap` as completed ([#9226](https://github.com/python/typeshed/pull/9226))
...
[stubsabot] Bump python-nmap to 0.7.* ([#8174](https://github.com/python/typeshed/pull/8174))

Co-authored-by: hauntsaninja <>

## 0.6.7 (2022-04-27)

Drop Python 2 support from python-nmap ([#7706](https://github.com/python/typeshed/pull/7706))
