...
Fix a default in `pycurl` and update `apt_dependencies` ([#9961](https://github.com/python/typeshed/pull/9961))
...
pycurl: Add missing constants  ([#9373](https://github.com/python/typeshed/pull/9373))
...
`pycurl`: Add a few missing constants ([#9262](https://github.com/python/typeshed/pull/9262))

## 7.45.1.2 (2022-11-23)

Add missing symbols in `pycurl` stubs ([#9207](https://github.com/python/typeshed/pull/9207))
...
`pycurl`: Add `CurlMulti.setopt()` ([#8315](https://github.com/python/typeshed/pull/8315))

## 7.45.0 (2022-06-25)

[stubsabot] Bump pycurl to 7.45.* ([#8163](https://github.com/python/typeshed/pull/8163))
...
contextvars, pycurl: make classes final ([#7334](https://github.com/python/typeshed/pull/7334))
...
Replace METADATA stubtest key with stubtest_apt_packages ([#6704](https://github.com/python/typeshed/pull/6704))
