...
Add missing constants to `OpenSSL/crypto.pyi` ([#10345](https://github.com/python/typeshed/pull/10345))
...
[stubsabot] Bump pyOpenSSL to 23.2.* ([#10235](https://github.com/python/typeshed/pull/10235))
...
[pyOpenSSL] Fix return type of SSLeay_version ([#10037](https://github.com/python/typeshed/pull/10037))
...
Update pyOpenSSL to 23.1.* ([#9939](https://github.com/python/typeshed/pull/9939))
...
pyOpenSSL: Introduce PARTIAL_CHAIN constant ([#9727](https://github.com/python/typeshed/pull/9727))
...
[stubsabot] Bump pyOpenSSL to 23.0.* ([#9446](https://github.com/python/typeshed/pull/9446))
...
isort: Add more to extra_standard_library ([#9098](https://github.com/python/typeshed/pull/9098))
...
Update pyOpenSSL stubs to 22.1.* ([#8838](https://github.com/python/typeshed/pull/8838))

## 22.0.10 (2022-07-29)

Add `pyopenssl.rand` module ([#8435](https://github.com/python/typeshed/pull/8435))

## 22.0.9 (2022-07-25)

Add `pyopenssl.version` module ([#8384](https://github.com/python/typeshed/pull/8384))

## 22.0.8 (2022-07-24)

Add missing methods to `OpenSSL.SSL.Connection` ([#8374](https://github.com/python/typeshed/pull/8374))
...
`pyopenssl`: `data` argument for `set_ocsp_server_callback`/`set_ocsp_client_callback` can be non-`bytes` ([#8371](https://github.com/python/typeshed/pull/8371))

## 22.0.6 (2022-07-22)

Add `ocsp` callback setters to `OpenSSL.SSL` ([#8367](https://github.com/python/typeshed/pull/8367))

## 22.0.5 (2022-07-22)

Add `proto_version` setters to `OpenSSL.SSL` ([#8363](https://github.com/python/typeshed/pull/8363))
...
pyOpenSSL: Adapt to changes in 22.0.0 ([#7080](https://github.com/python/typeshed/pull/7080))
...
Add pyOpenSSL 21 constants ([#6273](https://github.com/python/typeshed/pull/6273))
