...
[stubsabot] Mark prettytable as obsolete since 3.5.0 ([#9023](https://github.com/python/typeshed/pull/9023))
...
prettytable: get_X_string return str ([#8791](https://github.com/python/typeshed/pull/8791))

## 3.4.1 (2022-09-03)

`prettytable`: Fix stubtest errors ([#8676](https://github.com/python/typeshed/pull/8676))

Fixes #8674. A partial revert of 9e696275018ef3798bb596821ad0d8b4b8e80ab6.

## 3.4.0 (2022-08-29)

Bump prettytable to 3.4.* ([#8621](https://github.com/python/typeshed/pull/8621))
...
Bump prettytable to 3.3.* ([#8207](https://github.com/python/typeshed/pull/8207))
