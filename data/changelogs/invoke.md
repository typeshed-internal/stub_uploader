...
Mark `invoke` as obsolete since `2.1.2` ([#10100](https://github.com/python/typeshed/pull/10100))
...
invoke: Update `Context.cd()` to accept a `pathlib.Path` or a string ([#9823](https://github.com/python/typeshed/pull/9823))
...
Update `invoke` stubs to 2.0.* ([#9669](https://github.com/python/typeshed/pull/9669))
...
Add Call object support for invoke tasks ([#8916](https://github.com/python/typeshed/pull/8916))

## 1.7.3.15 (2022-11-23)

Use modern syntax in test-case files where possible ([#9261](https://github.com/python/typeshed/pull/9261))
...
Fix `invoke` regression ([#8950](https://github.com/python/typeshed/pull/8950))

* Fix `invoke` regression

## 1.7.3.2 (2022-10-19)

Add types to `invoke.Task.__call__` ([#8918](https://github.com/python/typeshed/pull/8918))

## 1.7.3.1 (2022-10-01)

Add `parser` to `invoke.completion.complete.complete` ([#8819](https://github.com/python/typeshed/pull/8819))

Closes https://github.com/python/typeshed/issues/8818

## 1.7.3 (2022-07-13)

Add types to `invoke.Runner.run` ([#8279](https://github.com/python/typeshed/pull/8279))
...
Bump invoke to 1.7.* ([#8111](https://github.com/python/typeshed/pull/8111))

## 1.6.8 (2022-05-25)

invoke: Fix unconstrained TypeVar ([#7943](https://github.com/python/typeshed/pull/7943))
...
Improve types of invoke/env.pyi ([#7780](https://github.com/python/typeshed/pull/7780))
...
Mark pre/post tasks in invoke tasks as iterable ([#7531](https://github.com/python/typeshed/pull/7531))

Fix wrong return type of invoke decorator ([#7536](https://github.com/python/typeshed/pull/7536))

Closes #7530

## 1.6.4 (2022-03-21)

Fix invoke task decorator ([#7511](https://github.com/python/typeshed/pull/7511))

The decorator can be called with and without (). The current types only consider the first case

## 1.6.3 (2022-03-17)

Add annotations to invoke.tasks ([#7502](https://github.com/python/typeshed/pull/7502))
...
Add stubs for invoke ([#6938](https://github.com/python/typeshed/pull/6938))
