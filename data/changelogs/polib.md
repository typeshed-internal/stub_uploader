...
[stubsabot] Bump polib to 1.2.* ([#9804](https://github.com/python/typeshed/pull/9804))
...
Mark `polib` as complete ([#9244](https://github.com/python/typeshed/pull/9244))

## 1.1.12 (2022-04-27)

Drop Python 2 support from polib ([#7714](https://github.com/python/typeshed/pull/7714))
