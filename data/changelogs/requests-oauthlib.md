...
Fix the type for `OAuth2Session.authorization_url` ([#10878](https://github.com/python/typeshed/pull/10878))

fix the type for `OAuth2Session.authorization_url`

## 1.3.0.0 (2023-09-11)

Add stubs for requests-oauthlib ([#10658](https://github.com/python/typeshed/pull/10658))
