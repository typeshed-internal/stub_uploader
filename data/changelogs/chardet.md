...
chardet: UniversalDetector.feed accepts bytearray ([#10107](https://github.com/python/typeshed/pull/10107))
...
Simplify `chardet` type imports ([#10080](https://github.com/python/typeshed/pull/10080))
...
[stubsabot] Mark chardet as obsolete since 5.1.0 ([#9318](https://github.com/python/typeshed/pull/9318))
...
Add missing `__version__` to `chardet.__init__` ([#8401](https://github.com/python/typeshed/pull/8401))
...
chardet: improve stubs ([#8155](https://github.com/python/typeshed/pull/8155))

## 5.0.0 (2022-06-25)

[stubsabot] Bump chardet to 5.0.* ([#8150](https://github.com/python/typeshed/pull/8150))

Co-authored-by: hauntsaninja <>

## 4.0.4 (2022-04-27)

Drop Python 2 support from chardet ([#7708](https://github.com/python/typeshed/pull/7708))
