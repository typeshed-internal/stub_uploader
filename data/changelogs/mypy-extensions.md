## [1.1.0.20260724](https://pypi.org/project/types-mypy-extensions/1.1.0.20260724/) (2026-07-24)
...
Improve `__(r)or__` signatures for TypedDict classes ([#10565](https://github.com/python/typeshed/pull/10565))
...
Update `mypy_extensions` stubs to 1.0.x ([#9675](https://github.com/python/typeshed/pull/9675))

## 0.4.24 (2022-08-17)

Normalise use of `Never` vs `NoReturn` ([#8549](https://github.com/python/typeshed/pull/8549))

## 0.4.23 (2022-08-13)

Improve `.keys()`, `.values()`, `.items()` methods for `TypedDict`s ([#8532](https://github.com/python/typeshed/pull/8532))

## 0.4.22 (2022-08-10)

Add missing `TypedDict` methods and `ClassVar`s ([#8512](https://github.com/python/typeshed/pull/8512))
...
`mypy_extensions`: fix `TypeVar` usage ([#7937](https://github.com/python/typeshed/pull/7937))
...
Improve trait signature in mypy_extensions.pyi ([#7027](https://github.com/python/typeshed/pull/7027))
...
mypy_extensions: fix NoReturn, remove inaccurate comment ([#6595](https://github.com/python/typeshed/pull/6595))
