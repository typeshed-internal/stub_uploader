...
Update `python-crontab` to `3.0.*` ([#10475](https://github.com/python/typeshed/pull/10475))
...
Complete `python-crontab` ([#9306](https://github.com/python/typeshed/pull/9306))
...
crontab: upstream did some py2 cleanup ([#9406](https://github.com/python/typeshed/pull/9406))

Fixes #9405

## 2.7.0.0 (2022-12-23)

crontab: improve types, update to 2.7 ([#9392](https://github.com/python/typeshed/pull/9392))
...
Mark `python-crontab` as completed ([#8938](https://github.com/python/typeshed/pull/8938))

## 2.6.0.0 (2022-10-20)

Add stubs for python-cronlog ([#8917](https://github.com/python/typeshed/pull/8917))
