...
Mark pynput as completed ([#9235](https://github.com/python/typeshed/pull/9235))

## 1.7.5 (2022-09-12)

[pynput] Fix annotations of Controller.Key(Code) ([#8722](https://github.com/python/typeshed/pull/8722))

Document stubtest entries

## 1.7.4 (2022-09-10)

Run third-party stubtest under xvfb-run ([#8719](https://github.com/python/typeshed/pull/8719))
...
Add stubs for `pynput` package ([#7177](https://github.com/python/typeshed/pull/7177))
