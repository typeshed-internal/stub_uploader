...
subprocess: Improve bytes-related types ([#9100](https://github.com/python/typeshed/pull/9100))
...
boto: drop dependency on types-six ([#8792](https://github.com/python/typeshed/pull/8792))
...
Improve `boto` callbacks ([#8201](https://github.com/python/typeshed/pull/8201))
