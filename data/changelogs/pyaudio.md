...
`pyaudio`: fix stubtest failures ([#9416](https://github.com/python/typeshed/pull/9416))
...
Add missing symbols in `pyaudio` stubs ([#9206](https://github.com/python/typeshed/pull/9206))
