...
babel: Mark babel as obsolete since 2.12.1 ([#9832](https://github.com/python/typeshed/pull/9832))
...
Add type annotations for `babel.messages` subpackage ([#9455](https://github.com/python/typeshed/pull/9455))

## 2.11.0.7 (2022-11-25)

Add  methods for Catalog and Message from babel package ([#9278](https://github.com/python/typeshed/pull/9278))
...
Improvements to existing Babel types ([#9190](https://github.com/python/typeshed/pull/9190))

## 2.11.0.4 (2022-11-12)

Add more type annotations for Babel ([#9125](https://github.com/python/typeshed/pull/9125))
...
Added types for `babel.core` and `babel.numbers` ([#9111](https://github.com/python/typeshed/pull/9111))

## 2.11.0.1 (2022-11-05)

Add new functions for Babel 2.11.0 ([#9091](https://github.com/python/typeshed/pull/9091))

Co-authored-by: Alex Waygood <Alex.Waygood@Gmail.com>

## 2.11.0.0 (2022-11-02)

[stubsabot junior] Bump babel to 2.11.* ([#9064](https://github.com/python/typeshed/pull/9064))

## 2.10.0 (2022-07-01)

[stubsabot] Bump babel to 2.10.* ([#8222](https://github.com/python/typeshed/pull/8222))
...
Add babel.core.get_global ([#7063](https://github.com/python/typeshed/pull/7063))

## 2.9.5 (2022-01-07)

Update pyright ([#6840](https://github.com/python/typeshed/pull/6840))

Improve Babel dates stub ([#6730](https://github.com/python/typeshed/pull/6730))
