...
`Xlib`: Use `bool` for parameters where the default is `False` ([#9990](https://github.com/python/typeshed/pull/9990))

## 0.33.0.10 (2023-03-27)

Add more default values to python-xlib ([#9960](https://github.com/python/typeshed/pull/9960))

## 0.33.0.9 (2023-03-22)

Add defaults for params and constants in python-xlib ([#9642](https://github.com/python/typeshed/pull/9642))
...
python-xlib: remove workaround for pytype ([#9590](https://github.com/python/typeshed/pull/9590))

## 0.33.0.2 (2023-01-16)

`Xlib`: Import `Pattern` from `re`, not `typing` ([#9544](https://github.com/python/typeshed/pull/9544))

Refs https://github.com/PyCQA/flake8-pyi/pull/324

## 0.33.0.1 (2023-01-03)

Re-enable NQA102 ([#9426](https://github.com/python/typeshed/pull/9426))

re-enable NQA102

## 0.33.0.0 (2022-12-28)

Bump python-xlib to 0.33 ([#9420](https://github.com/python/typeshed/pull/9420))
...
Added complete Xlib stubs ([#9279](https://github.com/python/typeshed/pull/9279))
