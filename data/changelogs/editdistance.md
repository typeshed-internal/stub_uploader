...
`editdistance`: delete the `bycython` submodule ([#9380](https://github.com/python/typeshed/pull/9380))

## 0.6.3.1 (2022-10-20)

Remove `editdistance` from `pyright`'s exclude ([#8941](https://github.com/python/typeshed/pull/8941))
...
[stubsabot] Bump editdistance to 0.6.* ([#8120](https://github.com/python/typeshed/pull/8120))
