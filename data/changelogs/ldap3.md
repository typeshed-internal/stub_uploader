## [2.9.13.20260827](https://pypi.org/project/types-ldap3/2.9.13.20260827/) (2026-08-27)
...
Bump flake8-pyi to 23.1.1 ([#9599](https://github.com/python/typeshed/pull/9599))
...
Resolve stubtest allowlist entries for `ldap3` ([#9532](https://github.com/python/typeshed/pull/9532))

## 2.9.13.4 (2023-01-12)

Overhaul `ldap3` stubs ([#9470](https://github.com/python/typeshed/pull/9470))
...
Make the `ldap3` stubs platform-agnostic ([#9180](https://github.com/python/typeshed/pull/9180))
...
Add SAFE_RESTARTABLE strategy to ldap3 Connection client_strategy parameter ([#8547](https://github.com/python/typeshed/pull/8547))
...
Overhaul `socket` stubs on Windows and MacOS ([#8106](https://github.com/python/typeshed/pull/8106))
...
Add iterable and ServerPool types to ldap3 Connection.server parameter  ([#7101](https://github.com/python/typeshed/pull/7101))
...
Add stubs for ldap3 ([#6561](https://github.com/python/typeshed/pull/6561))
