...
Mark stubs for backports.ssl_match_hostname as no longer updated ([#9882](https://github.com/python/typeshed/pull/9882))
...
Remove `ssl_match_hostname` from pyright exclude ([#9116](https://github.com/python/typeshed/pull/9116))
...
Fix distribution name backports.ssl_match_hostname ([#5997](https://github.com/python/typeshed/pull/5997))
