...
[stubsabot] Bump singledispatch to 4.1.* ([#10624](https://github.com/python/typeshed/pull/10624))
...
[stubsabot] Bump singledispatch to 4.0.* ([#9447](https://github.com/python/typeshed/pull/9447))
...
Complete singledispatch stub ([#9201](https://github.com/python/typeshed/pull/9201))
...
singledispatch: fix lint ([#7178](https://github.com/python/typeshed/pull/7178))

Co-authored-by: hauntsaninja <>

Add singledispatchmethod to singledispatch ([#6089](https://github.com/python/typeshed/pull/6089))
