...
[stubsabot] Bump flake8-simplify to 0.21.* ([#10755](https://github.com/python/typeshed/pull/10755))
...
[stubsabot] Bump flake8-simplify to 0.20.* ([#9993](https://github.com/python/typeshed/pull/9993))
...
[stubsabot] Bump flake8-simplify to 0.19.* ([#8052](https://github.com/python/typeshed/pull/8052))
...
Update flake8-simplify ([#7339](https://github.com/python/typeshed/pull/7339))
...
Mark some fields as ClassVars ([#6510](https://github.com/python/typeshed/pull/6510))

## 0.14.0 (2021-12-03)

Add stubs for flake8-simplify ([#6480](https://github.com/python/typeshed/pull/6480))
