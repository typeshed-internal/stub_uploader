...
[stubsabot] Bump regex to 2023.10.3 ([#10832](https://github.com/python/typeshed/pull/10832))

## 2023.8.8.0 (2023-08-10)

[stubsabot] Bump regex to 2023.8.8 ([#10553](https://github.com/python/typeshed/pull/10553))
...
[stubsabot] Bump regex to 2023.6.3 ([#10252](https://github.com/python/typeshed/pull/10252))
...
[stubsabot] Bump regex to 2023.5.5 ([#10138](https://github.com/python/typeshed/pull/10138))
...
[stubsabot] Bump regex to 2023.5.4 ([#10131](https://github.com/python/typeshed/pull/10131))
...
[stubsabot] Bump regex to 2023.3.23 ([#9933](https://github.com/python/typeshed/pull/9933))
...
[stubsabot] Bump regex to 2023.3.22 ([#9927](https://github.com/python/typeshed/pull/9927))
...
Add test case for recent `types-regex` regression ([#9269](https://github.com/python/typeshed/pull/9269))

## 2022.10.31.2 (2022-11-24)

regex: fix type signatures using Scanner ([#9266](https://github.com/python/typeshed/pull/9266))

## 2022.10.31.1 (2022-11-23)

Mark regex as completed ([#9214](https://github.com/python/typeshed/pull/9214))

## 2022.10.31.0 (2022-11-01)

[stubsabot] Bump regex to 2022.10.31 ([#9050](https://github.com/python/typeshed/pull/9050))
...
[stubsabot] Bump regex to 2022.9.13 ([#8751](https://github.com/python/typeshed/pull/8751))
...
[stubsabot] Bump regex to 2022.8.17 ([#8562](https://github.com/python/typeshed/pull/8562))

Co-authored-by: stubsabot <>

## 2022.7.25.0 (2022-07-29)

[stubsabot] Bump regex to 2022.7.25 ([#8432](https://github.com/python/typeshed/pull/8432))

Co-authored-by: stubsabot <>

## 2022.7.9.0 (2022-07-15)

[stubsabot] Bump regex to 2022.7.9 ([#8300](https://github.com/python/typeshed/pull/8300))

Co-authored-by: hauntsaninja <>

## 2022.6.2.0 (2022-06-26)

Bump regex to 2022.6.2 ([#8162](https://github.com/python/typeshed/pull/8162))
...
regex: accept buffers ([#7680](https://github.com/python/typeshed/pull/7680))
...
regex stubs: Add __getitem__ method to Match ([#7372](https://github.com/python/typeshed/pull/7372))
...
Add regex stubs ([#6713](https://github.com/python/typeshed/pull/6713))
