...
`cryptography`: Add some missing `@abstractmethod` decorators ([#8598](https://github.com/python/typeshed/pull/8598))

## 3.3.22 (2022-08-16)

cryptography: Rename parameter of serialize_key_and_certificates ([#8543](https://github.com/python/typeshed/pull/8543))

## 3.3.21 (2022-04-28)

cryptography: make `oid` attributes readonly ([#7731](https://github.com/python/typeshed/pull/7731))
...
remove quoted strings ([#6933](https://github.com/python/typeshed/pull/6933))
...
Remove unused allowlist entries ([#6671](https://github.com/python/typeshed/pull/6671))
...
Add defaults to GCM.__init__ arguments ([#6207](https://github.com/python/typeshed/pull/6207))
