...
[stubsabot] Mark tzlocal as obsolete since 5.2 ([#10921](https://github.com/python/typeshed/pull/10921))
...
[stubsabot] Bump tzlocal to 5.1 ([#10836](https://github.com/python/typeshed/pull/10836))
...
Bump `tzlocal` to `5.0.1` ([#10188](https://github.com/python/typeshed/pull/10188))

## 5.0.0.0 (2023-05-15)

Bump `tzlocal` to `5.0` ([#10183](https://github.com/python/typeshed/pull/10183))

## 4.3.0.0 (2023-03-19)

[stubsabot] Bump tzlocal to 4.3 ([#9903](https://github.com/python/typeshed/pull/9903))
...
Comments explaining why `keyboard` and `tzlocal` are not run on multiple platforms ([#9188](https://github.com/python/typeshed/pull/9188))

## 4.2.2.1 (2022-10-23)

Remove tzlocal from pyright's exclude ([#8969](https://github.com/python/typeshed/pull/8969))

## 4.2.2 (2022-07-20)

Allowlist useless modules ([#8340](https://github.com/python/typeshed/pull/8340))
...
[stubsabot] Bump tzlocal to 4.2 ([#8184](https://github.com/python/typeshed/pull/8184))
...
Add get_localzone_name to tzlocal ([#6912](https://github.com/python/typeshed/pull/6912))
