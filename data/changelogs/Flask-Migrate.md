...
Remove `SQLAlchemy` stubs ([#10389](https://github.com/python/typeshed/pull/10389))
...
`Flask-Migrate`: Add `Flask` as a dependency ([#9517](https://github.com/python/typeshed/pull/9517))

## 4.0.0.0 (2022-11-23)

Add stubs for flask-migrate ([#8967](https://github.com/python/typeshed/pull/8967))
