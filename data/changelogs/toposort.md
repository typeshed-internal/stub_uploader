...
[stubsabot] Bump toposort to 1.10 ([#9816](https://github.com/python/typeshed/pull/9816))
...
[stubsabot] Bump toposort to 1.9 ([#9503](https://github.com/python/typeshed/pull/9503))

Release: https://pypi.org/pypi/toposort/1.9

## 1.8.0.0 (2023-01-11)

Bump toposort to 1.8 ([#9489](https://github.com/python/typeshed/pull/9489))
...
toposort: Make argument types less restrictive ([#6531](https://github.com/python/typeshed/pull/6531))
...
Create stubs for toposort ([#6048](https://github.com/python/typeshed/pull/6048))
