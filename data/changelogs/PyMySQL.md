...
Bump PyMySQL to `1.1.*` ([#10376](https://github.com/python/typeshed/pull/10376))
...
Update PyMySQL constants ([#7670](https://github.com/python/typeshed/pull/7670))
...
Add __enter__/__exit__ to pymysql.Connection ([#7069](https://github.com/python/typeshed/pull/7069))
...
Improve pymysql.converters stubs ([#6267](https://github.com/python/typeshed/pull/6267))
