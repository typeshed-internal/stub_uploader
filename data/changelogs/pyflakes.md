## [3.4.0.20260724](https://pypi.org/project/types-pyflakes/3.4.0.20260724/) (2026-07-24)
...
Update pyflakes stubs for v3.1.* ([#10518](https://github.com/python/typeshed/pull/10518))
...
pyflakes: fix stubtest ([#9273](https://github.com/python/typeshed/pull/9273))

Fixes #9272

## 3.0.0.0 (2022-11-24)

Bump pyflakes to 3.0.* ([#9264](https://github.com/python/typeshed/pull/9264))
...
Bump pyflakes to 2.5.* ([#8495](https://github.com/python/typeshed/pull/8495))
...
Add stubs for pyflakes ([#7175](https://github.com/python/typeshed/pull/7175))
