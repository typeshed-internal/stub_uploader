...
Bump simplejson to 3.19.* ([#10049](https://github.com/python/typeshed/pull/10049))
...
[stubsabot] Bump simplejson to 3.18.* ([#9198](https://github.com/python/typeshed/pull/9198))
...
add default for simplejson.JSONEncoder.iterencode ([#9135](https://github.com/python/typeshed/pull/9135))

https://github.com/simplejson/simplejson/blob/43645252224d4e529c22cb78ac42f241d6426073/simplejson/encoder.py#L304

## 3.17.7.1 (2022-10-20)

Remove `simplejson` from `pyright`'s exclude ([#8945](https://github.com/python/typeshed/pull/8945))
...
Remove Python 2 support from simplejson ([#7704](https://github.com/python/typeshed/pull/7704))
...
Create simplejson.errors ([#6492](https://github.com/python/typeshed/pull/6492))
