## [0.6.0.20260724](https://pypi.org/project/types-pyasn1/0.6.0.20260724/) (2026-07-24)
...
Bump pyasn1 to 0.5.* ([#10801](https://github.com/python/typeshed/pull/10801))
...
Add stubs for `pyasn1` ([#9437](https://github.com/python/typeshed/pull/9437))
