## [1.10.0.20250319](https://pypi.org/project/types-tree-sitter-languages/1.10.0.20250319/) (2025-03-19)

* Run stubtest with Python 3.13 ([#13638](https://github.com/python/typeshed/pull/13638))

## [1.10.0.20240612](https://pypi.org/project/types-tree-sitter-languages/1.10.0.20240612/) (2024-06-12)

* Remove `tree-sitter` ([#12118](https://github.com/python/typeshed/pull/12118))

## [1.10.0.20240201](https://pypi.org/project/types-tree-sitter-languages/1.10.0.20240201/) (2024-02-01)
...
[stubsabot] Bump tree-sitter-languages to 1.8.* ([#10889](https://github.com/python/typeshed/pull/10889))
...
[stubsabot] Bump tree-sitter-languages to 1.7.* ([#10474](https://github.com/python/typeshed/pull/10474))
...
[stubsabot] Bump tree-sitter-languages to 1.6.* ([#10364](https://github.com/python/typeshed/pull/10364))
...
[stubsabot] Bump tree-sitter-languages to 1.5.* ([#8750](https://github.com/python/typeshed/pull/8750))
...
[stubsabot] Bump tree-sitter-languages to 1.4.* ([#8623](https://github.com/python/typeshed/pull/8623))

## 1.3.0 (2022-08-17)

Add stubs for tree-sitter-languages ([#8548](https://github.com/python/typeshed/pull/8548))
