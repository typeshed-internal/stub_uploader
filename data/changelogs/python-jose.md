...
Fix python-jose unverified jws and jwt functions ([#9662](https://github.com/python/typeshed/pull/9662))
...
Use `pyasn1` in `python-jose` ([#9469](https://github.com/python/typeshed/pull/9469))

## 3.3.4 (2022-07-15)

python-jose: improvements to jose.backends ([#8294](https://github.com/python/typeshed/pull/8294))

## 3.3.3 (2022-07-13)

Complete python-jose typing ([#8258](https://github.com/python/typeshed/pull/8258))

## 3.3.2 (2022-07-06)

Improve python-jose jws and jwt modules ([#8238](https://github.com/python/typeshed/pull/8238))
...
Add stubs for Python-Jose ([#7613](https://github.com/python/typeshed/pull/7613))
