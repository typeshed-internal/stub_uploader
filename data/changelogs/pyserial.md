...
`_CField` as a generic descriptor protocol ([#10595](https://github.com/python/typeshed/pull/10595))
...
pyserial: Fix read and write methods ([#9825](https://github.com/python/typeshed/pull/9825))
...
`pyserial`: fix stubtest errors ([#9722](https://github.com/python/typeshed/pull/9722))
...
Enable stubtest for `pyserial` ([#9692](https://github.com/python/typeshed/pull/9692))

## 3.5.0.1 (2023-02-02)

Fix optional USB attributes in pyserial's `ListPortInfo` ([#9654](https://github.com/python/typeshed/pull/9654))
...
Add stubs for the pyserial package ([#9347](https://github.com/python/typeshed/pull/9347))
