## [1.4.3.20260907](https://pypi.org/project/types-dateparser/1.4.3.20260907/) (2026-09-07)

* Update to 1.4.3 ([#16345](https://github.com/python/typeshed/pull/16345))

    Closes: #16341

## [1.4.2.20260813](https://pypi.org/project/types-dateparser/1.4.2.20260813/) (2026-08-13)

* Update to 1.4.2 ([#16190](https://github.com/python/typeshed/pull/16190))
...
Mark `dateparser` as complete ([#9312](https://github.com/python/typeshed/pull/9312))

Co-authored-by: Alex Waygood <Alex.Waygood@Gmail.com>

## 1.1.4.3 (2022-11-23)

dateparser: delete DIGIT_USE_PATTERN ([#9243](https://github.com/python/typeshed/pull/9243))

Fixes #9242

## 1.1.4.2 (2022-11-04)

dateparser: add new parameter ([#9081](https://github.com/python/typeshed/pull/9081))

Fixes #9079

## 1.1.4.1 (2022-10-21)

dateparser: add negative argument to get_date_from_timestamp ([#8954](https://github.com/python/typeshed/pull/8954))
...
`dateparser`: Remove redundant import of `_typeshed.Self` ([#8041](https://github.com/python/typeshed/pull/8041))
...
Update dateparser stubs for 1.1 ([#7368](https://github.com/python/typeshed/pull/7368))
...
check_new_syntax.py: check nested annotations ([#6167](https://github.com/python/typeshed/pull/6167))

## 1.0.5 (2021-10-13)

dateparser.search.search_dates: allow arbitrary-length tuples for languages argument ([#6166](https://github.com/python/typeshed/pull/6166))
...
Specify concrete types for DateDataParser attributes ([#6075](https://github.com/python/typeshed/pull/6075))
