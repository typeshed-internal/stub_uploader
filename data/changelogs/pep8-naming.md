...
Add two more methods to `pep8-naming` stub ([#8864](https://github.com/python/typeshed/pull/8864))

## 0.13.0 (2022-06-26)

[stubsabot] Bump pep8-naming to 0.13.* ([#8181](https://github.com/python/typeshed/pull/8181))
...
Fix missing return type in pep8ext_naming ([#7031](https://github.com/python/typeshed/pull/7031))

Add stubs for pep8-naming ([#7030](https://github.com/python/typeshed/pull/7030))
