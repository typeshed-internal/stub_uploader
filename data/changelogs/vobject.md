...
`__unicode__` always returns `str` ([#9248](https://github.com/python/typeshed/pull/9248))

Mark first argument of `__[get|set|del]attr__` as `str` ([#9245](https://github.com/python/typeshed/pull/9245))

## 0.9.8.4 (2022-11-13)

Explain why `vobject` is not tested on Windows ([#9175](https://github.com/python/typeshed/pull/9175))
...
Mark `vobject` as complete ([#9120](https://github.com/python/typeshed/pull/9120))
...
Fix return type of readComponents() ([#6143](https://github.com/python/typeshed/pull/6143))
