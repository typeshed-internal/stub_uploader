...
Update dockerfile-parse to 2.0.* ([#9357](https://github.com/python/typeshed/pull/9357))

## 1.2.0.1 (2022-12-01)

Remove `dockerfile-parse` from pyright's exclude ([#9310](https://github.com/python/typeshed/pull/9310))

Remove unnecessary dependency on types-six

## 1.2.0.0 (2022-12-01)

Add stubs for dockerfile-parse ([#9305](https://github.com/python/typeshed/pull/9305))
