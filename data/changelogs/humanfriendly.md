...
Mark `humanfriendly` as complete ([#9309](https://github.com/python/typeshed/pull/9309))
...
[stubsabot] Bump humanfriendly to 10.0.* ([#8118](https://github.com/python/typeshed/pull/8118))
...
flake8 config: remove line that exists only for Python-2 checking ([#7570](https://github.com/python/typeshed/pull/7570))
...
Annotate humanfriendly.__init__.pyi ([#6209](https://github.com/python/typeshed/pull/6209))
